    ...
    return (
      <div className="h-[500px] w-full flex items-center justify-center">
        <div className="text-center space-y-2">
          ...
          <p className="text-zinc-500 text-xs">Impossible de récupérer les données</p>
        </div>
      </div>
    );
  }
  ...
  return (
    ...
    >
      ...
      <div className="flex items-baseline gap-4 mb-6">
        ...
        <span className="text-3xl font-black text-white font-mono ml-auto tabular-nums">
        ...
        <ResponsiveContainer width="100%" height="100%">
          <AreaChart data={chartData}>
            ...
            <Tooltip
              ...
              labelStyle={{ color: '#A1A1AA', fontWeight: '600', fontSize: '11px' }}
